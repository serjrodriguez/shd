...
<body>
	...
	{!! Form::open(['route' => 'empleado.reports.genera', 'method' => 'POST']) !!}
		
		<div class="form-group" style="display: none;">
		{!! Form::text('id_usuario', Auth::user()->id, ['type' => 'hidden']) !!}
		</div>

		<div class="form-group">
			{!! Form::label('periodo', 'Selecciona el periodo de tiempo con el cual deseas generar el reporte') !!}
			{!! Form::select('periodo', ['dia' => 'Periodo por dia', 'mensual' => 'Periodo mensual'], null,['class' => 'form-control', 'placeholder' => 'Selecciona un periodo de tiempo', 'required']) !!}
		</div>
